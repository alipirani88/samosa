...
def extract_gatk_Mutect():
    ...
    for v in vcf:
        ...
        if len(alt) == 1 and alt[0] == "<NON_REF>":
            ...
            print "More than 5 alleles found. Please add a rule to the source code"
            exit()
...
Final_LDV_abund_file = "%s" % args.Mutect_vcf.replace('_raw.vcf', '_Final_LDV_abund_frequency.csv')
