rule instrain:
    ...
    shell:
        ...
        "inStrain profile {input.bamdedup} {input.reference} -o {output.instrain_out} -s {input.reference_stb} --pairing_filter non_discordant -c 1 -l 0.92 --detailed_mapping_info"
